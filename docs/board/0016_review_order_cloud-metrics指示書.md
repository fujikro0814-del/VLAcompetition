...
- 付け直し: 枝 `cloud/metrics` での仮の番号 0012 を、本線が取り込むときに 0016 に付け直した（2026-09-25、決裁の指示）。「番号」の行のほか（返信先・本文・題）の 0012〜0015 は枝での仮の番号のまま（対応: 0012→0016、0013→0017、0014→0018、0015→0019）。それ以外の番号は本線の番号。対応表は STATUS.md
