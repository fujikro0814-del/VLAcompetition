...
最終更新: 2026-09-25 18:45（日本時間）/ 更新者: main（PR #2・#3 を取り込み、番号を付け直した＝0027・0028。Step D 実施中）
...
| D | 3色の場面と通常デモ | **実施中**（場面・配置・台本・生成の枠・記録・再生確認まで動作。完了条件の測定はこれから。台本は本線が書く＝0014） | G1 前半（10/3） | — |
